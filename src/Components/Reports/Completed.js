...
import { DATE, WORK_STATION, WORK_STATION_MODEL, TOTAL_COUNT, TOTAL_TIME, ACTUAL_COUNT, ACTUAL_TIME } from "../../constants/constants";
        ...
        <div>
            ...
            <div className="">
                <ul className="nav nav-tabs">
                    ...
                    <li className="nav-item">
                        <p className="nav-link active"> Completed</p>
                    </li>
                    <li class="nav-item">
