        ...
        <div>
            <div className="topnav ">
                <nav className="navbar navbar-light bg-light">
                    ...
                    <Link to="/Settings"><button className={props.settings}><svg xmlns="http://www.w3.org/2000/svg" width="20" height="22" fill="currentColor" class="bi bi-gear-wide-connected" viewBox="0 0 16 16">
                        ...
                        <div className="modal-dialog">
                            ...
                            <button className="btn btn-outline-secondary"  data-bs-dismiss="modal" onClick={logOut} type="button">Yes</button>
                            </div>
                            </div>
                            <div className="col">
                            <div className="d-grid gap-2">
